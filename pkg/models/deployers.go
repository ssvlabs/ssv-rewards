...
var (
	deployerAllColumns            = []string{"owner_address", "deployer_address", "tx_hash"}
	deployerColumnsWithoutDefault = []string{"owner_address", "deployer_address", "tx_hash"}
...
func (o *Deployer) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"deployers\"", updateOnConflict, ret, update, conflict, insert)
